...
//                              |--S--> oasis --E--> desert --pyramid--> tomb (shard 3: pharaoh)
//   town --N gate--> peaks --cave--> ice_cavern (shard 4: frost_wyrm)
//                      |--E--> volcano (shard 5: infernal) --N--> citadel (hollow_king)
(function (R) {
  ...
  add('town', {
    ...
    build(M) {
      ...
      M.exit(28, 0, 5, 1, 'peaks', 'south', { requires: () => done('main_8'), locked: 'Captain Garrick: "The Frostfang pass is sealed by the Elder\'s order."' });
      M.point('start', 30, 24);
      M.point('east', 56, 21);
      M.point('north', 30, 5);
  ...
  add('marsh', {
    ...
    build(M) {
      ...
      M.exit(45, 79, 7, 1, 'oasis', 'north', { requires: () => done('main_5'), locked: 'Warden Osric: "The south road is overrun. Deal with the Broodmother first."' });
      M.point('west', 2, 40);
      M.point('south', 48, 76);
    },
  });
  ...
  add('peaks', {
    ...
    build(M) {
      ...
      M.exit(95, 39, 1, 7, 'volcano', 'west', { requires: () => done('main_10'), locked: "A wall of Skaldr's enchanted ice seals the pass east." });
      M.point('south', 48, 84);
      M.point('east', 90, 42);
    },
  });
  ...
  add('volcano', {
    ...
    build(M) {
      ...
      M.exit(45, 0, 7, 1, 'citadel', 'entrance', { requires: () => done('main_12'), locked: 'A wall of black flame bars the Citadel road. Only the Ember Crown can part it.' });
      M.point('west', 3, 44);
